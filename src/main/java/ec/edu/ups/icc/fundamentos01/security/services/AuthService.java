...
public class AuthService {
    @Autowired
    private  AuthenticationManager authenticationManager; // Valida credenciales
    @Autowired
    private UserRepository userRepository;               // Acceso a BD
    @Autowired
    private RoleRepository roleRepository;               // Gestión de roles
    @Autowired
    private PasswordEncoder passwordEncoder;             // Hash de passwords
    @Autowired
    private  JwtUtil jwtUtil;                            // Generación de tokens
